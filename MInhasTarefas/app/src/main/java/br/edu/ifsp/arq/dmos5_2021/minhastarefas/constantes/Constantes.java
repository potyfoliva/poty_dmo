package br.edu.ifsp.arq.dmos5_2021.minhastarefas.constantes;
...
public class Constantes {
    ...
    public static final String KEY_DESCRICAO_ANTERIOR = "descricao_anterior";
    ...
    public static final String ATTR_DESCRICAO = "descricao";
    ...
    public static final String LISTA2 = "lista2";

    public static final String THEME_KEY = "current_theme";
    public static final String THEME_PADRAO = "padrao";
    public static final String THEME_CANDY = "candy";
    public static final String THEME_ESCURO = "escuro";

    public static final String THEME_SELECIONADO = "theme_selecionado";
